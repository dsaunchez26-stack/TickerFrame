        ...
        {!activeId && !loadingMessages ? (
          <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-4 overflow-y-auto p-6">
            ...
            <div className="text-center">
              <div className="font-heading text-lg font-semibold">Ask about any stock, signal, or trend</div>
              <p className="mx-auto mt-1 max-w-md text-xs text-muted-foreground">
                Answers pull from this site's own cached scans — fundamentals, signals, insider activity, and sector data.
              </p>
            </div>
